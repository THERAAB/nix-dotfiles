...
prompt_symbol_color='003'
prompt_symbol_error_color='001'

user_color='002'
user_machine_symbol_color='005'
machine_color='007'
...
user_bubble="$(foreground $user_color)$bubble_left$(foreground $user_color)$user_symbol$bubble_right"
...
PROMPT='$user_bubble$machine_bubble$filepath_bubble$_newline$end_of_prompt%{$reset_color%}'
